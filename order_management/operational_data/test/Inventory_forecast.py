...
def late_month():
    ''' 下旬数据'''
    sku_data = connect_mysql(sku_sql, type='dict')
    for data_dict in sku_data:
        ...
        connect_mysql(insert_update_sql)

    print(spu_sql)
    spu_date = connect_mysql(spu_sql, type='dict')
    for spu_dict in spu_date:
        ...
        connect_mysql(insert_spu_update_sql)
